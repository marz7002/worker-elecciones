...
def download():
    ...
    try:
        ...
        id_ = 0
        file = 'tweets-new_version-' + str(today.date()) + '.txt'
        ...
        with open(file, 'wb') as f:
            ...
            header = u"/".join(['id', 'tweet_id', 'date', 'user_id',
                                ...
                                'mention', 'location', 'lang', 'long', 'tweet'])
            ...
            for item in r:
                if 'text' in item:
                    ...
                    long = 1
                    try:
                        tweet = item['extended_tweet']['full_text'].replace('\n', '').replace(
                            '\t', '')
                    except:
                    ...
                    new_line = [new_id, tweet_id, date, user_id,
                                ...
                                mentions, location, lang, long, tweet]
                    ...
                    # sendinf file to S3 every 10K new tweet
                    if id_ % 10000 == 0:
                       client.upload_file(
